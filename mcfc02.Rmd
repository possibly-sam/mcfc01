...
q3 <- q2 $ my_table %>% mc $ CMCCollapsedTable()
...
# But what do the probabilities & the values look like?
...
p %>% hist( breaks=30, main="Prob")
b %>% log() %>% hist( breaks=30, main="Log Best")
e %>% log() %>% hist( breaks=30, main="Log Expected")
w %>% log() %>% hist( breaks=30, main="Log Worst")
...
p %>% sample(4500) %>% shapiro.test( )
b %>% log() %>% sample(4500) %>% shapiro.test()
e %>% log() %>% sample(4500) %>% shapiro.test()
w %>% log() %>% sample(4500) %>% shapiro.test()
...
p %>% table() %>% sort(TRUE) %>% head()
b %>% table() %>% sort(TRUE) %>% head()
e %>% table() %>% sort(TRUE) %>% head()
w %>% table() %>% sort(TRUE) %>% head()
