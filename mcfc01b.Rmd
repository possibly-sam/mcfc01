...
filter_categories %>% write.csv("filter_categories")

filter_categories[ order(filter_categories$the_length), ] %>% View()
...
mc $ make_histogram_discrete_filtered (Risk, "A14 Section 2", 43376, "Target", 999, 999)
